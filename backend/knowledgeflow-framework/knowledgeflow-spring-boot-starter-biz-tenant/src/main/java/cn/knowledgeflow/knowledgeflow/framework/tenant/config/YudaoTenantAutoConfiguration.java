...
import cn.knowledgeflow.framework.redis.config.YudaoCacheProperties;
import cn.knowledgeflow.framework.security.core.service.SecurityFrameworkService;
import cn.knowledgeflow.framework.tenant.core.aop.TenantIgnore;
import cn.knowledgeflow.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.knowledgeflow.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.knowledgeflow.framework.tenant.core.job.TenantJobAspect;
import cn.knowledgeflow.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.knowledgeflow.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.knowledgeflow.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.knowledgeflow.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.knowledgeflow.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.knowledgeflow.framework.tenant.core.service.TenantFrameworkService;
import cn.knowledgeflow.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.knowledgeflow.framework.tenant.core.web.TenantContextWebFilter;
import cn.knowledgeflow.framework.tenant.core.web.TenantVisitContextInterceptor;
...
import static cn.knowledgeflow.framework.common.util.collection.CollectionUtils.convertList;
...
public class YudaoTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "cn.knowledgeflow.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "cn.knowledgeflow.framework.quartz.core.handler.JobHandler")
